...
echo "5. Clean Logging Mode (iOS with condensed output)"
...
case $choice in
    ...
    4)
        ...
        ;;
    5)
        echo "Using Clean Logging Mode (condensed output)..."
        python3 /Users/twu/GitHub/video-download/yt_dlp_clean_logger.py "$url"
        ;;
    6)
